...
public class DetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //----
        int cateIDProductDetail = category.getCateIDByProductID(id);
        List<Product> listRelatedProduct = product.getRelatedProduct(cateIDProductDetail);

        List<Review> listAllReview = review.getAllReviewByProductID(id);
        int countAllReview = listAllReview.size();

        List<Account> listAllAcount = account.getAllAccount();

        Product last = product.getLast();
