        ...
        <header>
            ...
            <main>
                <div class="container pt-4">
                    ...
                    <section class="mb-4" style="margin-top: 65px;">
                        <div class="card">
                            <div class="card-header py-3 row " style="
                                 margin-top: 65px;
                                 ">
                                <div class="col-sm-3">
                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">As a Seller </th>
                                            <th scope="col">As an Administrator</th>
                    ...
                    <form action="addAccount" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group form-check">
                                ...
                                <label class="form-check-label" for="isSell">As a Seller </label>
                            </div>

                            <div class="form-group form-check">
                                <input name="isAdmin" value="1" type="checkbox" class="form-check-input" id="isAdmin">
                                <label class="form-check-label" for="isAdmin">As an Administrator</label>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
