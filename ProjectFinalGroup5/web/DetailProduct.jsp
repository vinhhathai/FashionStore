    ...
    <body class="skin-light">
                ...
                <div class="container">
                    ...
                    <section class="mb-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><span class="mr-1"><strong>$${detail.price }</strong></span><span
                                    class="text-grey"><strong><s></s></strong></span></p>
                ...
                <div class="classic-tabs">
                    ...
                    <div class="tab-content" id="advancedTabContent">
                        <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                            ...
                            <h6>$${String.format("%.02f",detail.price) }</h6>
                            <p class="pt-1">${detail.description}</p>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-3 mb-5">
                                ...
                                <div class="">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <h5>${o.title }</h5>
                                        <p><span class="text-danger mr-1"><strong>${o.price }$</strong></span><span
                                                class="text-grey"><strong><s></s></strong></span></p>
        ...
        <script>
            window.addEventListener("load", function loadAmountCart() {
                $.ajax({
                    url: "/ProjectFinalGroup5/loadAllAmountCart",
            ...
            function addReview(pID) {
                ...
                $.ajax({
                    url: "/ProjectFinalGroup5/addReview",
                    type: "get", //send it through get method
                    data: {
                        productID: pID,
